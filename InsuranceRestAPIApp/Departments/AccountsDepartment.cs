...
public class AccountsDepartment
{
    public void OnPolicyPurchased(Policy policy)
    {
        ...
        DoublyLinkedList<Policy> policyDoublyLinkedList=policyRepository.GetAllPolicies();
        policyDoublyLinkedList.insertAtEnd(policy);
        policyRepository.SaveAllPolicies(policyDoublyLinkedList);
    ...
    public void OnPolicyCancel(string policyno)
    {
      ...
      foreach(Policy policy in policyDoublyLinkedList)
        {
    ...
    public void OnPremiumPaid(Premium premium)
    {
        ...
        DoublyLinkedList<Premium> premiumDoublyLinkedList = premiumRepository.GetAllPremimum();
        premiumDoublyLinkedList.insertAtEnd(premium);
        premiumRepository.SaveAllPremium(premiumDoublyLinkedList);
        Console.WriteLine("====================================");
